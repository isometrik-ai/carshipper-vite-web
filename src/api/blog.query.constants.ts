export const BLOG_QUERY_PARAMS = [
  ...
  "populate[blog_posts][populate][cover][fields][0]=url",
  "populate[blog_posts][populate][cover][fields][1]=alternativeText",
  "populate[blog_posts][populate][cover][fields][2]=width",
  "populate[blog_posts][populate][cover][fields][3]=height",
] as const;
