...
export default function QuotePageClient() {
  ...
  const pageData = useMemo(() => {
    ...
    const distanceTable = content.find(
      c => c.__component === "shared.comparison-table" && (c as ComparisonTable).section_title === "Average Cost by Distance"
    ) as ComparisonTable | undefined;
    const vehicleTable = content.find(
      c => c.__component === "shared.comparison-table" && (c as ComparisonTable).section_title === "Average Cost by Vehicle Type"
    ) as ComparisonTable | undefined;
