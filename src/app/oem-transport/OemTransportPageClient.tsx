...
export default function OemTransportPageClient() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                {pageData.hero?.main_headline || "OEM Transport"}{" "}
            ...
            {pageData.serviceCards.service_cards && pageData.serviceCards.service_cards.length > 0 ? (
              <div className="grid md:grid-cols-3 gap-8">
                {pageData.serviceCards.service_cards.map((card: any, index: number) => {
                  const CardIcon = card.icon_name ? (getIcon(card.icon_name) as LucideIcon) : null;
                  return (
                    <motion.div
                      key={card.id || index}
                      initial={{ opacity: 0, y: 20 }}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                {pageData.cta.headline || "Get Your OEM Transport Quote"}
              </h2>
