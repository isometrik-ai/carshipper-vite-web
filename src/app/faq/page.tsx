                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  {pageData.contactCTA.secondary_button ? (
                    <Button 
                      ...
                      size="lg"
                      onClick={() => {
                        const link = pageData.contactCTA.secondary_button?.button_link || "/quote";
                        if (link.startsWith("http") || link.startsWith("tel:") || link.startsWith("mailto:")) {
                          window.location.href = link;
                        } else {
                          router.push(link);
                    ...
                    >
                      {pageData.contactCTA.secondary_button.button_text || "Get a Quote"}
                    </Button>
                  ) : null}
                </div>
              </motion.div>
            ...
            <div className="container mx-auto px-4 text-center">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                  {pageData.cta.headline || "Ready to Ship?"}
                </h2>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (pageData.cta.primary_button?.button_link) {
                        const link = pageData.cta.primary_button.button_link;
                        if (link.startsWith("http") || link.startsWith("tel:") || link.startsWith("mailto:")) {
                          window.location.href = link;
                        } else {
                          router.push(link);
