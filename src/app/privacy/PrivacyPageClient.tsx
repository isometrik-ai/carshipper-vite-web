        ...
        section.bullet_points.forEach((bullet) => {
          ...
          if (labelLower.includes("carrier")) {
            description =
              lines.find(
                (l) =>
                  l.toLowerCase().includes("pickup") ||
                  l.toLowerCase().includes("delivery")
              ) || "";
          } else if (labelLower.includes("service")) {
            description =
              lines.find(
                (l) =>
                  l.toLowerCase().includes("third-party") ||
            ...
            description =
              lines.find(
                (l) =>
                  l.toLowerCase().includes("required by law") ||
                  l.toLowerCase().includes("disclose")
              ) || "";
          }
