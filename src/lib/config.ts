...
export const BLOG_API_URL = (ENV_CONFIG?.BLOG_API_URL && typeof ENV_CONFIG.BLOG_API_URL === 'string' && ENV_CONFIG.BLOG_API_URL.trim() !== '')
? ENV_CONFIG.BLOG_API_URL : "https://wordpress-1336774-6338456.cloudwaysapps.com";
