...
const PURGE_TOKEN = import.meta.env.VITE_PURGE_CACHE_TOKEN as string | undefined;

/**
 * Purge Cache page – clears React Query cache when visited with valid token.
 * Use: /purge-cache?token=YOUR_SECRET
 * Set VITE_PURGE_CACHE_TOKEN in .env to require a token; if unset, purge is allowed (dev).
 */
const PurgeCache = () => {
